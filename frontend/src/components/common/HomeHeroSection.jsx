    ...
    return (
        ...
        <div className='w-full lg:w-1/2'>
            ...
            <div className='flex flex-col gap-2 sm:gap-3'>
                <button className='w-full sm:w-auto bg-blue-600 text-white py-2.5 px-6 text-sm sm:text-base rounded-md hover:bg-blue-700 transition-colors font-medium'>Book Appointment</button>
